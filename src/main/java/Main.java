...
public class Main {
  ...
  public static boolean LOG_DISTRIBUTION = true;

  public static void main(String[] args) {
    // Optimize existing tournament configuration
    // optimize("tournament-data/32_gpinter21.txt");
  ...
  public static void optimize(String fileName) {
    var highScore = 10.0f;
    var bestDefinition = Util.listToString(Util.readFile(fileName));
    ...
    for (int i = 0; i < 100_000; i++) {
      ...
      try {
        ...
        score = tournamentSimulation.play();
  ...
  public static void singleTournament(String fileName) {
    ...
    float score = tournamentSimulation.play();
    System.out.println(fileName + " got score: " + score);
  }
}
